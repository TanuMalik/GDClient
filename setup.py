...
setup(name="scidataspace-sciunit-client",
      ...
      install_requires=['leveldb>=0.193','configparser>=3.3.0r2', 'docker-py>=1.2.2'],
      packages=["scidataspace",
		...
		"scidataspace.client.commands"],
      package_data={
      		"scidataspace.client":[".gdclient/*"],
      		"scidataspace.client.globusonline.catalog.client": ["ca/*.pem"],
		"scidataspace.client.commands":["bin/ptu"]},
      scripts=["bin/gdclient.py"], #globusonline/catalog/client/cli/catalog.py"],
